...
#### iOS
Manually add `SpotifyMetadata.framework` and `SpotifyAudioPlayback.framework` from `node_modules/rn-spotify-sdk/ios/external/SpotifySDK` to *Linked Frameworks and Libraries* in the General tab of your project settings. Then add `$(SRCROOT)/../node_modules/rn-spotify-sdk/ios/external/SpotifySDK` to *Framework Search Paths* in your Build Settings.
